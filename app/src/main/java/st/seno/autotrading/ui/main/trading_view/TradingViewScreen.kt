...
fun TradingViewScreen(
    ...
    val tickerInfos = tradingViewViewModel.tickerInfos.collectAsStateWithLifecycle().value
    ...
    val ticker = tickerInfos?.ticker
    val bookmarkedTickers = tickerInfos?.favoriteTickers
    ...
    Box {
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            if (tickerInfos != null && ticker != null) {
                CandleChartView(
                    ...
                    candleChartWidth = tradingViewState.candleChartWidthState.floatValue,
                    candleChartHeight = tradingViewState.candleChartHeightState.floatValue,
                    ...
                    tradingVolumeHeight = tradingViewState.tradingVolumeHeightState.floatValue,
                    candleDateHeight = candleDateHeight,
                    tradesListHeightState = tradingViewState.tradesListHeightState.floatValue,
